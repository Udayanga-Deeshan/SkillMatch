...
async function getPublicJobs(): Promise<PublicJobsData> {
  try {
    ...
    return {
      jobs: [],
      categories: [
        { name: 'Information Technology (IT) & Software', count: 0 },
        { name: 'Sales & Marketing', count: 0 },
        { name: 'Finance & Accounting', count: 0 },
        { name: 'Human Resources (HR) & Administration', count: 0 },
        { name: 'Engineering & Manufacturing', count: 0 },
      ],
      totalJobs: 0
    };
  }
